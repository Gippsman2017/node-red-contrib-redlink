module.exports = function (RED) {
    ...
    function initTables() {
        ...
        alasql('CREATE TABLE notify (storeName STRING, serviceName STRING, srcStoreAddress STRING, srcStorePort INT , redlinkMsgId STRING, notifySent STRING, read BOOLEAN, redlinkProducerId STRING, notifyPath STRING, notifyTime INT)');
        ...
        alasql('CREATE TABLE globalStoreConsumers (localStoreName STRING, serviceName STRING, consumerId STRING, storeName STRING, direction STRING, storeAddress STRING, storePort INT, transitAddress STRING, transitPort INT, hopCount INT, ttl INT, ecm INT, erm INT)');
