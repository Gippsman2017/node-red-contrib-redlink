module.exports = function (RED) {
    ...
    function initTables() {
        ...
        alasql('CREATE TABLE notify (storeName STRING, serviceName STRING, producerIp STRING, producerPort INT , redlinkMsgId STRING, notifySent STRING)');//todo change this to list of consumer node ids
        alasql('CREATE TABLE inMessages (redlinkMsgId STRING, storeName STRING, serviceName STRING, message STRING, read BOOLEAN)');
