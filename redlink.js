module.exports = function (RED) {
    ...
    function initTables() {
        ...
        alasql('CREATE TABLE globalStoreConsumers (localStoreName STRING, globalServiceName STRING, globalStoreName STRING, globalStoreIp STRING, globalStorePort INT, direction STRING)');
